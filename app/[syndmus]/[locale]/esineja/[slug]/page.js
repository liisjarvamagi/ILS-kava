...
import { loadSchedule, findArtist, isValidSlug, scheduleAvailable} from '../../../../../lib/schedule';
...
export default async function ArtistPage({ params }) {
  const { locale, slug, syndmus } = params;
  ...
  return (
    <div className="artist-page">
      <div className="artist-hero2">
        ...
        <Link href={`${base}/esinejad`} className="icon-btn artist-hero2-back" aria-label={tr.back}>‹</Link>
      ...
      <div className="detail">
        ...
        <ArtistSessions performances={performances} stages={data.stages} locale={locale} base={base} />
      </div>
    </div>
  );
}
